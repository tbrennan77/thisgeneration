...
<section class="section-blog section-blog--single">
	<?php while ( have_posts() ) : the_post(); ?>
		<article <?php post_class( 'article-single' ); ?>>
			<?php
				$page_background_image = carbon_get_the_post_meta( 'crb_page_background_image' );
			?>

			<?php if ( has_post_thumbnail() || ! empty( $page_background_image ) ) : ?>
				<div class="article__thumbnail">
					<?php if ( ! empty( $page_background_image ) ) : ?>
						<div class="article__background">
							<div class="article__background-inner js-image-fit image-fit">
								<?php
									echo wp_get_attachment_image( $page_background_image, 'full' );
								?>
